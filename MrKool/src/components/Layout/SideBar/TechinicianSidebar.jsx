    ...
    <Sider collapsible>
      <div className="dashboard-logo" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
        ...
        <div className="user-info" style={{ marginLeft: '16px' }}>
          <Title level={4} style={{ color: 'white', textAlign: 'center' }}>Techinician</Title>
          <Text className="white-text" style={{ textAlign: 'center' }}>Technician</Text>
        </div>
      </div>
      <Menu
        theme="dark"
      ...
      >
        ...
        <Menu.Item key="/requestList" icon={<TruckOutlined style={{ fontSize: '18px', marginRight: '8px' }} />} style={{ padding: '8px 16px', marginBottom: '8px' }}>
          Manage Service
        </Menu.Item>
